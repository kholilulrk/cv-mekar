                ...
                <div class="card-body">
                    ...
                    <form class="form-horizontal" action="{{ route('admin.service.update', $service->id) }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="controls">
                                <input class="form-control" id="title" size="16" type="text" name="title" placeholder="Title" value="{{ $service->title }}">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="controls">
                                <img class="img-fluid" id="img-container" alt="Icon Service" width="100" height="100" src="{{ asset($service->showImage()) }}" />
                                <input type="file" onchange="document.getElementById('img-container').src = window.URL.createObjectURL(this.files[0])" name="icon">
                            </div>
                        </div>
