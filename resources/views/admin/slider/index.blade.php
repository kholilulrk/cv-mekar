        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <a href="{{ route('admin.slider.create') }}" class="btn btn-success pull-right"><i class="fa fa-plus"></i> Add Slider</a>
                </div>
                <div class="card-body">
                                ...
                                <td>
                                    ...
                                    <div class="btn-group">
                                        ...
                                        <div class="dropdown-menu" x-placement="bottom-start" style="position: absolute; transform: translate3d(0px, 34px, 0px); top: 0px; left: 0px; will-change: transform;">
                                            <a class="dropdown-item" href="{{ route('admin.slider.edit', $model->id) }}">Edit</a>
