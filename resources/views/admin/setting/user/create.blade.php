                ...
                <div class="card-body">
                    ...
                    <form class="form-horizontal" action="{{ route('admin.user.store') }}" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="controls">
                                <input class="form-control" id="name" size="16" type="text" name="name" placeholder="User full name">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-form-label" for="username">Username</label>
                            <div class="controls">
                                <input class="form-control" id="username" size="16" type="text" name="username" placeholder="Username for login">
                            </div>
                        </div>
                        <div class="form-group">
