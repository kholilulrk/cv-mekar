        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <a href="{{ route('admin.exhibition.create') }}" class="btn btn-success pull-right"><i class="fa fa-plus"></i> Add Exhibition</a>
                </div>
                <div class="card-body">
                                ...
                                <td>
                                    ...
                                    <div class="btn-group">
                                        ...
                                        <div class="dropdown-menu" x-placement="bottom-start" style="position: absolute; transform: translate3d(0px, 34px, 0px); top: 0px; left: 0px; will-change: transform;">
                                            <a class="dropdown-item" href="{{ route('admin.exhibition.edit', $model->id) }}">Edit</a>
                                            <form action="{{ route('admin.exhibition.destroy', $model->id) }}" method="post">
                                                {{ csrf_field() }}
                                                {{ method_field('delete') }}
