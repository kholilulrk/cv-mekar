            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    @if ($errors->any())
                        ...
                        @endforeach
                    @endif
                    <form class="form-horizontal" action="{{ route('admin.exhibition.update', $model->id) }}" method="post" enctype="multipart/form-data">
                        {{ method_field('PUT') }}
                        {{ csrf_field() }}
                        ...
                        <div class="form-group">
                            ...
                            <div class="controls">
                                <img class="img-fluid" id="img-container" alt="Exhibition Gallery" width="100" height="100" src="{{ asset($model->showImage()) }}" />
