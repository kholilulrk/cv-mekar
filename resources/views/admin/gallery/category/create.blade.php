            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    @if ($errors->any())
                        ...
                        @endforeach
                    @endif
                    <form class="form-horizontal" action="{{ route('admin.category_gallery.store') }}" method="post" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        <div class="form-group">
                            <label class="col-form-label" for="title">Title</label>
                            <div class="controls">
                                <input class="form-control" id="title" size="16" type="text" name="name" placeholder="Name of the category">
                            </div>
                        </div>
                        <div class="form-group">
