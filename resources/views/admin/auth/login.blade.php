...
<!-- Plugins -->
<link rel="stylesheet" type="text/css" href="{{url('admin/static/website/css/plugins-css.css')}}" />

<!-- Typography -->
<link rel="stylesheet" type="text/css" href="{{url('admin/static/website/css/typography.css')}}" />

<!-- Shortcodes -->
<link rel="stylesheet" type="text/css" href="{{url('admin/static/website/css/shortcodes/shortcodes.css')}}" />

<!-- Style -->
<link rel="stylesheet" type="text/css" href="{{url('admin/static/website/css/style.css')}}" />

<!-- Responsive -->
<link rel="stylesheet" type="text/css" href="{{url('admin/static/website/css/responsive.css')}}" />
...
<div class="wrapper">
    <div id="pre-loader">
        <img src="{{url('admin/static/website/preloader/loader-01.svg')}}" alt="">
    </div>
...
<!-- jquery -->
<script src="{{url('admin/static/website/js/jquery-3.3.1.min.js')}}"></script>

<!-- plugins-jquery -->
<script src="{{url('admin/static/website/js/plugins-jquery.js')}}"></script>

<!-- plugin_path -->
<script>
    var plugin_path = '{{url("admin/static/website/js/")}}/';
    console.log(plugin_path);
</script>

<!-- custom -->
<script src="{{url('admin/static/website/js/custom.js')}}"></script>
