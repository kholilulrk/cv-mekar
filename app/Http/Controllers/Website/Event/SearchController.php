...
class SearchController extends Controller
{
    ...
    {
        $category = CategoryArticle::where('is_ongoing', 1)->first();
        $data['models'] = Article::where('category_article_id', $category->id)->where('slug', 'like', "%$request->slug%")->latest()->paginate(3);
